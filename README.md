...
A clean, modern, and responsive portfolio website template built with HTML, CSS, and vanilla JavaScript. Features theme switching (light/dark) and basic language switching support (EN/ID).

## Features

*   Responsive Design (Mobile-first approach)
*   Light/Dark Theme Switching (syncs with system preference, persists in localStorage)
